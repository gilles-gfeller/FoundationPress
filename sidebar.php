    ...
    <ul class="nav sticky" data-sticky data-top-anchor="285" data-btm-anchor="search:top" style="width:100%">
      <li id="cresus-comptabilite">
        ...
        <div style="display: <?php echo displayBlock ("cresus-comptabilite") ?>">
          <?php if(function_exists('get_epsitecdocumentor')){ get_epsitecdocumentor('1','1'); } ?>
        </div>
      </li>
      <li id="cresus-salaires">
        ...
        <div style="display: <?php echo displayBlock ("cresus-salaires") ?>">
          <?php if(function_exists('get_epsitecdocumentor')){ get_epsitecdocumentor('2','1'); } ?>
        </div>
      </li>
      <li id="cresus-facturation">
        ...
        <div style="display: <?php echo displayBlock ("cresus-facturation") ?>">
          <?php if(function_exists('get_epsitecdocumentor')){ get_epsitecdocumentor('3','1'); } ?>
        </div>
      </li>
      <li id="cresus-gestion-pe">
        ...
        <?php if(function_exists('get_epsitecdocumentor')){ get_epsitecdocumentor('5','1'); } ?>
        </div>
      </li>
    </ul>
    ...
    <ul class="nav sticky" data-sticky data-top-anchor="285" data-btm-anchor="search:top" style="width:100%">
      <li id="cresus-comptabilite">
        ...
        <div style="display: <?php echo displayBlock ("cresus-finanzbuchhaltung") ?>">
          <?php if(function_exists('get_epsitecdocumentor')){ get_epsitecdocumentor('6','1'); } ?>
        </div>
      </li>
      <li id="cresus-salaires">
        ...
        <div style="display: <?php echo displayBlock ("cresus-lohnbuchhaltung") ?>">
          <?php if(function_exists('get_epsitecdocumentor')){ get_epsitecdocumentor('7','1'); } ?>
        </div>
      </li>
      <li id="cresus-facturation">
        ...
        <div style="display: <?php echo displayBlock ("cresus-faktura") ?>">
          <?php if(function_exists('get_epsitecdocumentor')){ get_epsitecdocumentor('8','1'); } ?>
        </div>
      </li>
      <li id="cresus-gestion-pe">
        ...
        <?php if(function_exists('get_epsitecdocumentor')){ get_epsitecdocumentor('9','1'); } ?>
        </div>
      </li>
    </ul>
