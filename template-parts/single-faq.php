    ...
    <div class="large-8 columns">
      ...
      <?php the_content(); ?>
        ...
        <?php if(get_the_tag_list()) {
          ...
          _e( 'tags', 'support' );
          echo '</h5>';
          echo get_the_tag_list('<ul class="etiquettes"><li data-tooltip aria-haspopup="true" class="has-tip" data-disable-hover="false" tabindex="1" title="Afficher tous les articles qui possèdent la même étiquette">','</li><li data-tooltip aria-haspopup="true" class="has-tip" data-disable-hover="false" tabindex="1" title="Afficher tous les articles qui possèdent la même étiquette">','</li></ul>');
          echo '</div>';
          }?>
